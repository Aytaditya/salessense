    ...
    <div className="min-h-screen p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div
            className={`border-3 border-dashed rounded-2xl p-8 text-center transition-all duration-300 h-fit ${
              isDragging 
          ...
          >
            <div className="flex flex-col items-center justify-center space-y-4">
              ...
              <label className="cursor-pointer bg-[#D93954] hover:bg-[#D93954] text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200 shadow-md hover:shadow-lg">
                <input
                  type="file"
                  accept=".csv,.xlsx,.xls"
                  className="hidden"
          ...
          <div className="flex flex-col">
            {fileData ? (
              <div className="rounded-2xl shadow-lg p-6 animate-fade-in bg-[#303030] border border-gray-600 h-full">
                ...
                <div className="flex justify-end space-x-3 mt-6">
                  <button className="px-4 py-2 text-sm font-medium text-white bg-[#D93954]  rounded-lg
                   hover:bg-[#d93954d9]  transition-colors duration-200">
                    Process Dataset
                  </button>
                </div>
              </div>
